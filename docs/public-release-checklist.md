...
- [x] Screenshots in `docs/demo/` match the current build and show WebMCP on. The three frames show the reset seed, SEP-1 with an Agent row, and the confirmed separation with a Human row.
